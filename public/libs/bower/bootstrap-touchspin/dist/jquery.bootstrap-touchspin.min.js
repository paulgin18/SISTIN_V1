...
!function (a) {
  ...
  a.fn.TouchSpin = function (b) {
    if ('destroy' === b) return void this.each(function () {
      var b = a(this),
      d = b.data();
      a(document).off(c(['mouseup',
      'touchend',
      'touchcancel',
      'mousemove',
      'touchmove',
      'scroll',
      'scrollstart'], d.spinnerid).join(' '))
    });
    var e = {
      min: 0,
      max: 100,
    ...
    return this.each(function () {
      ...
      function r() {
        ...
        a(document).on(c(['mouseup',
        'touchend',
        'touchcancel'], d).join(' '), function (a) {
          M && (a.preventDefault(), A())
        }),
        a(document).on(c(['mousemove',
        'touchmove',
        'scroll',
        'scrollstart'], d).join(' '), function (a) {
          M && (a.preventDefault(), A())
        }),
